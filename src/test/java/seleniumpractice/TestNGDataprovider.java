package seleniumpractice;
		...
		public class TestNGDataprovider {
			...
			void setUpClass() { // 1 time
				System.setProperty("webdriver.chrome.driver", "C:\\\\Users\\\\sreekanth.s\\\\Downloads\\\\chromedriver_win32_112\\chromedriver.exe");
			}
			...
			@Test(dataProvider = "calc-data", dataProviderClass = Test.class)
